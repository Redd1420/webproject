...
<div class="container">
    <div class="jumbotron">
        <h1>Welcome to MaRangu water management</h1>
    </div>
...
<em> The MaRangu water management system was the idea that
 arised due to scarcity of water in different places 
 around malangu villages, poor sewage management that led to enviromental pollution
  and made the enviroment uncomfortable to reside.
  <br /><br />
  Due to the problems listed above, the citizens of malangu with the help of the government created a system that manages the 
  supply of water and the maintainance of sewage water so as to reduce the problems facing the citizens of Dodoma.
...
Which is why our mission is and has always been pursuing the ensurance of reliable provission of affodarable, 
 and sustainable water and sanitation servicers to all residents of Dodoma.
<br /><br /><br />
And our vision to be a model water and sanitation services company in malangu. 
<br />
