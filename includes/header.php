...
<div class="container">
  ...
  <img class="col-md-12" src="assets/banner/bana2.jpg" width="1110">
  <div class="img">
          <center><ul>
                    ...
                    <li><a href="index.php?page=Board">Board of directors</a></li>
                  ...
                  <ul>
                  <li><a href="index.php?page=Pay-mpesa">Pay Bill Via M pesa</a></li>
